...
public class Question_110 {
    ...
    public static void postUserLogin(int accNo) {
        while (true) {
            ...
            System.out.println("[4] Get Transaction Receipt");
            System.out.println("[5] Check your Profile");
    ...
    public static void debitMoney(int accNo) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("atmTotalMoney.txt"))) {
            ...
            if (atmAmount < debitAmount) {
                ...
                System.out.println("The BANK currently does not have sufficient cash.");
                return;
            }
            try (BufferedReader br2 = new BufferedReader(new FileReader("userInfo.txt"))) {
                ArrayList<String> records = new ArrayList<>();
                ArrayList<String> profileRecords = new ArrayList<>();
                String line2;
                ...
                try (BufferedWriter bw = new BufferedWriter(new FileWriter("userInfo.txt"))) {
                    ...
                    try (BufferedWriter bw2 = new BufferedWriter(new FileWriter("atmTotalMoney.txt"))) {
                        ...
                        System.out.println("Unable to update BANK cash records.");
                    ...
                    try (BufferedReader br3 = new BufferedReader(new FileReader("userProfile.txt"))) {
                        String line3;
                        while ((line3 = br3.readLine()) != null) {
                            String[] data = line3.split("\\|");
                            int profileacc = Integer.parseInt(data[0]);
                            if (profileacc == accNo) {
                                profileRecords.add(profileacc + "|" + String.valueOf(updatedBalance) + "|" + data[2]
                                        + "|" + data[3] + "|" + data[4]);
                            } else {
                                profileRecords.add(line3);
                            }
                        }
                        try (BufferedWriter bw3 = new BufferedWriter(new FileWriter("userProfile.txt"))) {
                            for (String record : profileRecords) {
                                bw3.write(record);
                                bw3.newLine();
                            }
                        } catch (Exception e) {
                            System.out.println("Transaction Completed.");
                            System.out.println("However, transaction history could not be updated on your profile.");
                        }
                    } catch (Exception e) {
                        System.out.println("Transaction Completed.");
                        System.out.println("However, transaction history can't be accessed on this time.");
            ...
            System.out.println("BANK Service Unavailable.");
            System.out.println("Unable to access BANK cash records.");
            System.out.println("Please try again later.");
            programExit();
        }
    }

    public static void creditMoney(int accNo) {
        int creditAmount;
        while (true) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("atmTotalMoney.txt"))) {
            ...
            try (BufferedReader br2 = new BufferedReader(new FileReader("userInfo.txt"))) {
                ...
                while ((line2 = br2.readLine()) != null) {
                    ...
                    if (fileAccNo == accNo) {
                        found = true;
                        fileBalance += creditAmount;
                        updatedBalance = fileBalance;
                        String newRecord = accNo + "|" +
                                filePin + "|" +
                                fileBalance + "|" +
                                "ACTIVE";
                        records.add(newRecord);
                ...
                try (BufferedWriter bw2 = new BufferedWriter(new FileWriter("atmTotalMoney.txt"))) {
                    bw2.write(String.valueOf(atmAmount + creditAmount));
                } catch (IOException e) {
                    System.out.println("Transaction Warning!");
                    System.out.println("Unable to update BANK cash records.");
                    System.out.println("Please contact system administrator.");
                ...
                try (BufferedWriter writer = new BufferedWriter(new FileWriter("transactionHistory.txt", true))) {
                    ...
                    System.out.println("\n-------------------------------------------------------------------");
                    System.out.println("Transaction Successful.");
                    System.out.println("Credited Amount :      Rs. " + creditAmount);
                    System.out.println("Available Balance :    Rs. " + updatedBalance);
                    System.out.println("Date and Time :        " + dateTime);
                    System.out.println("Thank you for banking with us.");
                    System.out.println("-------------------------------------------------------------------");
                ...
                try (BufferedReader br3 = new BufferedReader(new FileReader("userProfile.txt"))) {
                    ...
                    while ((line3 = br3.readLine()) != null) {
                        String[] data = line3.split("\\|");
                        int profileAccNo = Integer.parseInt(data[0]);
                        if (profileAccNo == accNo) {
                            data[1] = String.valueOf(updatedBalance);
                            profileRecords
                                    .add(profileAccNo + "|" + data[1] + "|" + data[2] + "|" + data[3] + "|" + data[4]);
                        } else {
                            profileRecords.add(line3);
                        }
                    }
                    ...
                    System.out.println("Transaction Completed.");
                    System.out.println("However, profile records could not be updated.");
                }
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("atmTotalMoney.txt"))) {
            ...
            try (BufferedWriter bw = new BufferedWriter(new FileWriter("atmTotalMoney.txt"))) {
                ...
                try (BufferedWriter writer = new BufferedWriter(new FileWriter("atmAdminTransaction.txt", true))) {
                    ...
                    writer.newLine();
                    System.out.println("\n-------------------------------------------------------------------");
                    System.out.println("BANK Cash Refilled Successfully.");
                    System.out.println("Admin ID            : " + adminId);
                    System.out.println("Credited Amount     : Rs. " + credit);
                    System.out.println("Current BANK Balance : Rs. " + atmAmount);
                    System.out.println("Date and Time       : " + dateTime);
                    System.out.println("-------------------------------------------------------------------");
                    return;
                } catch (Exception e) {
                ...
                System.out.println("Unable to update BANK balance records.");
                System.out.println("Please try again later.");
                return;
            }
        } catch (Exception e) {
            System.out.println("BANK Service Unavailable.");
            System.out.println("Unable to access BANK records.");
            System.out.println("Please try again later.");
            return;
        }
    }
    ...
    public static void checkAtmBalance() {
        try (BufferedReader br = new BufferedReader(new FileReader("atmTotalMoney.txt"))) {
            ...
            String currentTime = LocalDateTime.now()
                    .format(DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss"));
            System.out.println("\n-------------------------------------------------------------------");
            System.out.println("Available BANK Balance : Rs. " + line);
            System.out.println("Balance Inquiry Time : " + currentTime);
            System.out.println("\n-------------------------------------------------------------------");
            return;
            ...
            System.out.println("Bank Server Error.");
            System.out.println("Unable to retrieve BANK balance.");
            System.out.println("Please try again later.");
            return;
        }
    }
    ...
    public static void atmTransactionChecker() {
        try (BufferedReader br = new BufferedReader(new FileReader("atmAdminTransaction.txt"))) {
            ...
            if (!found) {
                System.out.println("No BANK transaction records found.");
            }
            System.out.println("===================================================================");

        } catch (Exception e) {
            System.out.println("Server Error!");
            System.out.println("Unable to retrieve BANK transaction records.");
            System.out.println("Please try again later.");
        }
    }

    public static void profileChecker(int accNo) {
        System.out.println("\n-------------------------------------------------------------------");
        try (BufferedReader br = new BufferedReader(new FileReader("userProfile.txt"))) {
            boolean found = false;
            String line;
            while ((line = br.readLine()) != null) {
                String[] data = line.split("\\|");
                ...
                if (fileAccNo == accNo) {
                    found = true;
                    System.out.println("Account Number      : " + accNo);
                    System.out.println("Account Holder Name : " + data[2]);
                    System.out.println("Mobile Number       : " + data[3]);
                    System.out.println("Address             : " + data[4]);
                    System.out.println("Current Balance     : Rs." + data[1]);
                    break;
                }
            }
            if (!found) {
    ...
    public static void profileInfoChanger() {
        int accNo;
        while (true) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("userProfile.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (fileaccNo == accNo) {
                    ...
                    System.out.println("Current Mobile Number : " + data[3]);
                    System.out.print("Enter New Mobile number : ");
                    String newmob;
                    while (true) {
                        newmob = sc.nextLine().trim();
                        if (newmob.matches("\\d{10}")) {
                            break;
                        }
                        System.out.print("Enter a valid 10-digit mobile number : ");
                    }
                    System.out.println("Current Address : " + data[4]);
                    ...
                    String newRecord = fileaccNo + "|" + data[1] + "|" + newName + "|" + newmob + "|" + newaddress;
                    records.add(newRecord);
                } else {
                    records.add(line);
                }
            ...
            try (BufferedWriter bw = new BufferedWriter(
                    new FileWriter("userProfile.txt"))) {
                for (String record : records) {
                    bw.write(record);
                    bw.newLine();
                }
    ...
    public static void postAdminLogin(int adminId) {
        while (true) {
            System.out.println();
            System.out.println("\n-------------------------------------------------------------------");
            System.out.println("[1] Refill BANK");
            System.out.println("[2] Check Balance");
            System.out.println("[3] Change Customer Status");
            System.out.println("[4] Check VAULT Transaction History");
